...
<head>
    ...
    <!-- Favicon -->
    {{--<link rel="shortcut icon" href="FRONTEND/site/img/favicon.ico" type="image/x-icon" />--}}
    {{--<link rel="apple-touch-icon" sizes="57x57" href="FRONTEND/site/img/apple-touch-icon-57x57.png">--}}
    {{--<link rel="apple-touch-icon" sizes="60x60" href="FRONTEND/site/img/apple-touch-icon-60x60.png">--}}
    {{--<link rel="apple-touch-icon" sizes="72x72" href="FRONTEND/site/img/apple-touch-icon-72x72.png">--}}
    {{--<link rel="apple-touch-icon" sizes="76x76" href="FRONTEND/site/img/apple-touch-icon-76x76.png">--}}
    {{--<link rel="apple-touch-icon" sizes="114x114" href="FRONTEND/site/img/apple-touch-icon-114x114.png">--}}
    {{--<link rel="apple-touch-icon" sizes="120x120" href="FRONTEND/site/img/apple-touch-icon-120x120.png">--}}
    {{--<link rel="apple-touch-icon" sizes="144x144" href="FRONTEND/site/img/apple-touch-icon-144x144.png">--}}
    {{--<link rel="apple-touch-icon" sizes="152x152" href="FRONTEND/site/img/apple-touch-icon-152x152.png">--}}
    {{--<link rel="apple-touch-icon" sizes="180x180" href="FRONTEND/site/img/apple-touch-icon-180x180.png">--}}
    {{--<link rel="icon" type="image/png" href="FRONTEND/site/img/favicon-16x16.png" sizes="16x16">--}}
    {{--<link rel="icon" type="image/png" href="FRONTEND/site/img/favicon-32x32.png" sizes="32x32">--}}
    {{--<link rel="icon" type="image/png" href="FRONTEND/site/img/favicon-96x96.png" sizes="96x96">--}}
    {{--<link rel="icon" type="image/png" href="FRONTEND/site/img/android-chrome-192x192.png" sizes="192x192">--}}
    {{--<meta name="msapplication-square70x70logo" content="FRONTEND/site/img/smalltile.png" />--}}
    {{--<meta name="msapplication-square150x150logo" content="FRONTEND/site/img/mediumtile.png" />--}}
    {{--<meta name="msapplication-wide310x150logo" content="FRONTEND/site/img/widetile.png" />--}}
    {{--<meta name="msapplication-square310x310logo" content="FRONTEND/site/img/largetile.png" />--}}
    ...
    <main class="site-container">
            ...
            <div class="nav-inside light-section">
                ...
                <div class="info-header info-header-default active-info">
                    <h6 class="text-semi-bold hide show-sm-block">
                        ...
                        <span class="text-middle">+(099)85-73-821</span>
                        <span class="pl-lg-20 text-middle mt-sm-10 mt-lg-0">+(099)56-23-638</span>
                    </h6>
                    ...
                    <h6 class="text-semi-bold hide show-sm-block ml-sm-40 ml-md-0">
                        ...
                        <span>Mo-Fr 11:00-00:00</span>
                        <span class="pl-lg-20 text-middle mt-sm-10 mt-lg-0">Sa-Sn 15:00-00:00</span>
                    </h6>
                    <div class="popup popup-2 hide-sm ml-20 ml-sm-0" data-toggle="popover" title="Working Hours" data-content="Mo-Fr 11:00-00:00 Sa-Sn 15:00-00:00">
                        <span class="icon icon-sm fa fa-clock-o"></span>
                    </div>

                    <a class="popup-gmaps primary-icon-link ml-20 ml-sm-0 hide show-sm-flex" href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom"><span class="icon icon-sm fa fa-map-marker"></span><span class="hide show-sm-block"> View Location</span></a>
        ...
        <div id="menu">
            ...
            <div class="main-nav">
                ...
                <ul class="">
                    ...
                    <li data-menuanchor="7Page"><a href="#7Page"><span class="h3 text-middle show-inline-block text-bold">07</span><span class="text-middle pl-20">Contact Us</span></a></li>
                </ul>
            </div>
        </div>
        ...
        <div id="fullpage">
            ...
            <header class="section section-default bg-1 light-section active" id="section0">
                <div class="">
                    <h1 class="default-font text-bold letter-spacing-30">Mango Café</h1>
                    <h2 class="default-font text-bold letter-spacing-30 mt-20">An inspiration restaurant</h2>
