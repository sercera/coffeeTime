...
<head>
    ...
    <!-- Stylesheets -->
    <link href='https://fonts.googleapis.com/css?family=Poppins:400,500,600,700%7CPlayfair+Display:400,700'
        ...
        <div class="nav">
            <div class="nav-inside light-section">
                ...
                <div class="info-header info-header-default active-info">
                    ...
                    <div class="popup popup-1 hide-sm" data-toggle="popover" title="Broj telefona"
                         data-content="{{$caffe->call_number}}">
                        <span class="icon icon-sm fa fa-phone"></span>
                    </div>
                    <h2 class="default-font text-bold letter-spacing-30" style="color:black"><a href="/">coffeeTime</a>
                    </h2>
                    ...
                    <div class="popup popup-2 hide-sm ml-20 ml-sm-0" data-toggle="popover" title="Radno vreme"
                         data-content="Pon-Ned {{$caffe->work_hour_from}}-{{$caffe->work_hour_to}}">
                        <span class="icon icon-sm fa fa-clock-o"></span>
                    </div>
                    <div class="popup popup-3 hide-sm ml-20 ml-sm-0" data-toggle="popover" title="Radno vreme"
                         data-content="Pon-Ned {{$caffe->work_hour_from}}-{{$caffe->work_hour_to}}">
                        <span class="icon icon-sm fa fa-clock-o"></span>
                    </div>
                </div>
                ...
                <div class="info-header info-header-content">
                    <a class="primary-icon-link btn-return hide show-sm-flex" href="#1Page"><span
                                class="icon icon-sm fa fa-home"></span> Početna strana</a>
                    <a class="primary-icon-link scroll-btn" href="#4Page"><span
                                class="icon icon-sm fa fa-file-text-o"></span> Rezervišite sto</a>
                        <a class="primary-icon-link scroll-btn" href="{{url('users/'.Auth::user()->user_id)}}"><span
                                    class="icon icon-sm fa fa-user"></span> Moj Profil</a>
                        <a class="primary-icon-link scroll-btn" href="{{url('/logout')}}"><span
                                    class="icon icon-sm glyphicon glyphicon-log-out"></span> Odjavi se</a>
                </div>
            </div>
        </div>
        <div id="menu">
            ...
            <div class="main-nav">
                ...
                <ul class="">
                    <li data-menuanchor="1Page"><a href="#1Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">01</span><span class="text-middle pl-20" style="color:black">Početna</span></a>
                    </li>
                    <li data-menuanchor="2Page"><a href="#2Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">02</span><span class="text-middle pl-20" style="color:black">O nama</span></a>
                    </li>
                    <li data-menuanchor="3Page"><a href="#3Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">03</span><span class="text-middle pl-20" style="color:black">Menu</span></a>
                    </li>
                    <li data-menuanchor="4Page"><a href="#4Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">04</span><span class="text-middle pl-20" style="color:black">Rezervacije</span></a>
                    </li>
                    <li data-menuanchor="5Page"><a href="#5Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">05</span><span class="text-middle pl-20" style="color:black">Postovi</span></a>
                    </li>
                    <li data-menuanchor="6Page"><a href="#6Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">06</span><span class="text-middle pl-20"
                                                                       style="color:black">Tim</span></a></li>
                    <li data-menuanchor="7Page"><a href="#7Page"><span
                                    class="h3 text-middle show-inline-block text-bold"
                                    style="color:black">07</span><span class="text-middle pl-20" style="color:black">Kontakt</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div id="fullpage">
            ...
            <header class="section section-default bg-1 light-section active" id="section0">
                <div class="">
                    ...
                    <h2 class="default-font text-bold letter-spacing-30 mt-20"
                        style="color:black">{{$caffe->short_description}}</h2>
                    ...
                    <br/>
                    <div>
                        <h5 class="default-font text-bold letter-spacing-30" style="color:black">Broj slobodnih
                            stolova: {{$mesta}}</h5>
                    </div>
                </div>
            </header>
                        ...
                        <div class="col-xl-12 mt-30 mt-md-50">
                            <div class="row flex-center flex-md-left">
                                <div class="col-sm-10 col-md-6">
                                    ...
                                    <div class="text-center text-lg-right mt-30"><a href="{{$caffe->www}}"
                                                                                    class="btn btn-md btn-primary">SAZNAJ
                                            VIŠE</a></div>
                                </div>
                                <div class="col-sm-10 col-md-6 col-lg-5 mt-40 mt-md-0">
                                    ...
                                    <p class="big second-font text-medium ls-0 mt-20">Pon-Ned {{$caffe->work_hour_from}}
                                        -{{$caffe->work_hour_to}}</p>
                                    <br/>
                    ...
                    <div class="row flex-center flex-lg-left">
                        ...
                        <div class="col-xl-12 mt-30 mt-md-50">
                            ...
                            <div class="col-md-6 col-lg-5 col-xl-offset-1 col-md-order-1">
                                <p class="second-font text-primary text-bold ls-0">CHOOSE A TABLE NUMBER TO RESERVE
                                    IT</p>
                            ...
                            <div class="col-sm-10 col-md-6 col-xl-5 mt-30 mt-md-0">
                                <p class="ls-0">Unesite broj stola koji zelite da rezervisete. Rezervacija vazi 15
                                    minuta od trenutka rezervacije.</p>
                                <div class="form">
                                    ...
                                    @if($user->fk_for_caffe==$caffe->caffe_id)
                                        @foreach($usersDetails as $userDetails)
                                            @if($userDetails->fk_for_user==$user->user_id)
                                                <div style="margin:15px; padding: 15px; box-shadow: 1px 1px 10px 2px silver;">
                                                    <img src="{{asset('images/caffe_images/' . $userDetails->image)}}"
                                                         width="300" height="300" class="scaling-image"
                                                         alt="{{$user->username}}" align="right" margin="5px">
